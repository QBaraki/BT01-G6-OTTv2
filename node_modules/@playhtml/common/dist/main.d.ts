...
export declare const MAX_PRESENCE_VALUE_BYTES = 4096;
...
export declare type PresenceClientMessage = PresenceJoinMessage | PresenceUpdateMessage | PresenceClearMessage;
...
export declare function savePlayerIdentityToStorage(identity: PlayerIdentity): void;
